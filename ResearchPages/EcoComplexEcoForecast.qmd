...
## A protist community, five months, two thermal regimes
...
```{=html}
<figure class="rp-fig">
<img src="../assets/figures/EcoComplexEcoForecast_fig1.png" alt="Schematic of the microbial system and the constant versus fluctuating temperature treatments." />
<figcaption>
...
```{=html}
<figure class="rp-fig">
<img src="../assets/figures/EcoComplexEcoForecast_fig2.png" alt="Forecasting workflow showing how abundance time series are split into training and forecast windows, then evaluated against truth." />
<figcaption>
...
```{=html}
<figure class="rp-fig">
<img src="../assets/figures/EcoComplexEcoForecast_fig3.png" alt="Scatter plot showing forecast skill rising with the number of interactions and falling with their mean strength." />
<figcaption>
...
```{=html}
<figure class="rp-fig">
<img src="../assets/figures/EcoComplexEcoForecast_fig4.png" alt="Effect of fluctuating temperature on forecast skill, with three of eight species showing significant degradation." />
<figcaption>
