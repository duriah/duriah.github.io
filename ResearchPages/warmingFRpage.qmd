...
```{=html}
<script>document.body.dataset.page='research';document.body.dataset.screenLabel='03 Research / Warming & FR';</script>
...
<h1>Warming can destabilise predator–prey functional responses</h1>
<p class="lede">
...
<h2>Does warming reshape the way predators eat their prey?</h2>
</div>
<div class="text">
<p>
The <em>functional response</em> describes how much prey a single predator
...
<h2>A ciliate pair, 24 hours, three temperatures</h2>
</div>
<div class="text">
<p>
We chose <em>Spathidium sp.</em>, a generalist ciliate predator, and its
preferred prey <em>Dexiostoma campylum</em>.
</p>

<figure class="rp-fig tight">
<img src="FRpic.png" alt="Microscope photographs of Spathidium sp. and Dexiostoma campylum." />
<figcaption>
...
<figure class="rp-fig">
<img src="FRexperiment.png" alt="Schematic of the experimental design." />
<figcaption>
...
<figure class="rp-fig">
<img src="FRmodel.png" alt="Diagram of the population-dynamic model." />
<figcaption>
...
<h2>Type III at 15 and 20 °C, Type II at 25 °C</h2>
</div>
<div class="text">
<p>
...
<figure class="rp-fig">
<img src="FRmodelfit.png" alt="Fitted functional response curves across the three temperatures." />
<figcaption>
...
<figure class="rp-fig">
<img src="FRresults.png" alt="Long-run simulated predator–prey dynamics across temperatures." />
<figcaption>
...
<h2>Shape changes are usually missing from food-web models</h2>
</div>
<div class="text">
<p>
