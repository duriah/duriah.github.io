...
```{=html}
<figure>
<img src="assets/img/schema_pipelines.webp" alt="Schematic: a soil sample is sequenced by the amplicon and whole-genome routes, traits are inferred per organism, and the result is a community view." width="1640" height="477" />
...
Method demos on <a href="lab.html">Lab</a>.
</div>
```
